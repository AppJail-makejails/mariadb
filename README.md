...
* `mariadb_tag` (default: `1011`): see [#tags](#tags).
...
appjail cmd local mariadb sh -c "rm -f var/db/pkg/*"
...
| Tag | Arch | Version |
| --- | --- | --- |
| `1011` | `amd64` | `13.2-RELEASE` |
| `106` | `amd64` | `13.2-RELEASE` |
| `105` | `amd64` | `13.2-RELEASE` |
